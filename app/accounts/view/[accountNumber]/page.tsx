...
const AccountView = ({ params }: { params: { accountNumber: string } }) => {
  ...
  return (
    <div>
      <Accordion defaultExpanded={true}>
        ...
        >
          <Typography variant="h6">{getAccountName(accountNumber)}</Typography>
        </AccordionSummary>
      ...
      <Accordion>
        ...
        <AccordionDetails id="account-contacts-content">
          <Contacts accountNumber={accountNumber} />
        </AccordionDetails>
      </Accordion>
      <Accordion>
        <AccordionSummary
        ...
        <AccordionDetails id="account-opportunities-content">
          <Opportunities accountNumber={accountNumber} />
        </AccordionDetails>
      </Accordion>
      <Accordion>
        <AccordionSummary
        ...
        <AccordionDetails id="account-orders-content">
          <AccountSalesOrders accountNumber={accountNumber} />
        </AccordionDetails>
      </Accordion>
      <Accordion>
        <AccordionSummary
        ...
        <AccordionDetails id="account-invoices-content">
          <AccountSalesInvoices accountNumber={accountNumber} />
        </AccordionDetails>
      </Accordion>
      <Accordion>
        <AccordionSummary
        ...
        <AccordionDetails id="account-assets-content">
          <AccountAssets accountNumber={accountNumber} />
        </AccordionDetails>
      </Accordion>
      <Accordion>
        <AccordionSummary
        ...
        <AccordionDetails id="account-keys-content">
          <AccountLicenseKeys accountNumber={accountNumber} />
        </AccordionDetails>
      </Accordion>
    </div>
  );
